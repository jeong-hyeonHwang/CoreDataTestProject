...
//       DataManager.shared.coreDataRandomvideoInformationGenerate(howMany: 30)
       ...
       // 기존 데이터로 테스트 시 주석 제거 & line.46, 47 주석
        ...
        DataManager.shared.repository.printRawData(standard: .gymName)
        DataManager.shared.repository.printAllSortedData(standard: .gymName)
        
        currentVideoInformation = DataManager.shared.repository.sortedVideoInformation[0]
...
//    }
    ...
    func caseUPDATE() {
        ...
        DataManager.shared.repository.printRawData(standard: sectionData.sortOption)
